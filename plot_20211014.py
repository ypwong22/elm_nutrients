...
fig.savefig(os.path.join(path_out, date + '_' + level + '_2.png'), dpi = 600., bbox_inches = 'tight')
plt.close()
...
fig.savefig(os.path.join(path_out, date + '_' + level + '_3.png'), dpi = 600., bbox_inches = 'tight')
plt.close()
