        ...
        for plot, plot_name in zip(chamber_list, chamber_list_names):
            if var == "ANPPtree":
                ...
                sim = (
                    (
                        (
                            collection_ts.loc[:, (plot, "AGNPP", 3, "hummock")] * 0.14
                            + collection_ts.loc[:, (plot, "AGNPP", 2, "hummock")] * 0.36
                        )
                        * 0.64
                        + (
                            collection_ts.loc[:, (plot, "AGNPP", 3, "hollow")] * 0.14
                            + collection_ts.loc[:, (plot, "AGNPP", 2, "hollow")] * 0.36
                        )
                        * 0.36
                    )
                ...
                sim = (
                    (
                        (
                            collection_ts.loc[:, (plot, "BGNPP", 2, "hummock")] * 0.36
                        ...
                        * 0.64
                        + (
                            ...
                            + collection_ts.loc[:, (plot, "BGNPP", 11, "hollow")] * 0.25
                        )
                        * 0.36
                    )
                    .groupby(collection_ts.index.year)
                ...
                sim = (
                    -(
                        collection_ts.loc[:, (plot, "NEE", 0, "hummock")] * 0.64
                        + collection_ts.loc[:, (plot, "NEE", 0, "hollow")] * 0.36
                    )
                    .groupby(collection_ts.index.year)
                    .mean()
                    * 86400
...
ax.legend(
    h, ["OBS_ACO2", "MOD ACO2", "OBS ECO2", "MOD ECO2"], loc=(-2.0, -0.65), ncol=4
)
fig.savefig(
